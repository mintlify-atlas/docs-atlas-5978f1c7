...
description: "DNS Handling is a Go HTTP service that automates custom domain ownership verification and TLS certificate issuance via ACME DNS-01 challenges."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Domain Lifecycle" icon="arrow-right-arrow-left" href="/concepts/domain-lifecycle">
    Understand every state transition and error condition in detail.
  </Card>
  <Card title="API Overview" icon="code" href="/api/overview">
    Full reference for every endpoint, request body, and response shape.
  </Card>
